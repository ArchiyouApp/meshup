...
const BooleanRegion3DJsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
...
export class BooleanRegion3DJs {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(BooleanRegion3DJs.prototype);
        obj.__wbg_ptr = ptr;
        BooleanRegion3DJsFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        BooleanRegion3DJsFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_booleanregion3djs_free(ptr, 0);
    }
    /**
     * Number of holes.
     * @returns {number}
     */
    holeCount() {
        const ret = wasm.booleanregion3djs_holeCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    holes() {
        const ret = wasm.booleanregion3djs_holes(this.__wbg_ptr);
     ...
     */
    get exterior() {
        const ret = wasm.booleanregion3djs_exterior(this.__wbg_ptr);
...
export class Curve3DJs {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Curve3DJs.prototype);
        obj.__wbg_ptr = ptr;
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        Curve3DJsFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
     ...
     */
    tangentAt(t) {
        const ret = wasm.curve3djs_tangentAt(this.__wbg_ptr, t);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Vector3Js.__wrap(ret[0]);
    }
    /**
     ...
     */
    tessellate(tol) {
        const ret = wasm.curve3djs_tessellate(this.__wbg_ptr, !isLikeNone(tol), isLikeNone(tol) ? 0 : tol);
        if (ret[3]) {
    ...
    static makeCircle(radius, center, normal) {
        ...
        const ret = wasm.curve3djs_makeCircle(radius, center.__wbg_ptr, normal.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Curve3DJs.__wrap(ret[0]);
    ...
    rotateAxis(angle, ax, ay, az) {
        const ret = wasm.curve3djs_rotateAxis(this.__wbg_ptr, angle, ax, ay, az);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Curve3DJs.__wrap(ret[0]);
     ...
     */
    getOnPlane() {
        const ret = wasm.curve3djs_getOnPlane(this.__wbg_ptr);
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    knotsDomain() {
        const ret = wasm.curve3djs_knotsDomain(this.__wbg_ptr);
     ...
     * @returns {Curve3DJs}
     */
    static makePolyline(points, closed) {
        const ptr0 = passArrayJsValueToWasm0(points, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.curve3djs_makePolyline(ptr0, len0, closed);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Curve3DJs.__wrap(ret[0]);
     ...
     */
    segmentCount() {
        const ret = wasm.curve3djs_segmentCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    controlPoints() {
        const ret = wasm.curve3djs_controlPoints(this.__wbg_ptr);
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    paramAtLength(len) {
        const ret = wasm.curve3djs_paramAtLength(this.__wbg_ptr, len);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0];
    ...
    static makeInterpolated(points, degree) {
        const ptr0 = passArrayJsValueToWasm0(points, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.curve3djs_makeInterpolated(ptr0, len0, degree);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Curve3DJs.__wrap(ret[0]);
     ...
     * @returns {any}
     */
    segmentTessellations(tol) {
        const ret = wasm.curve3djs_segmentTessellations(this.__wbg_ptr, !isLikeNone(tol), isLikeNone(tol) ? 0 : tol);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
     ...
     * @returns {number}
     */
    paramClosestToPoint(p) {
        _assertClass(p, Point3Js);
        const ret = wasm.curve3djs_paramClosestToPoint(this.__wbg_ptr, p.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0];
     ...
     */
    area() {
        const ret = wasm.curve3djs_area(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0];
     ...
     */
    bbox(tol) {
        const ret = wasm.curve3djs_bbox(this.__wbg_ptr, !isLikeNone(tol), isLikeNone(tol) ? 0 : tol);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayF64FromWasm0(ret[0], ret[1]).slice();
     ...
     */
    trim(t0, t1) {
        const ret = wasm.curve3djs_trim(this.__wbg_ptr, t0, t1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Curve3DJs.__wrap(ret[0]);
     ...
     */
    scale(s) {
        const ret = wasm.curve3djs_scale(this.__wbg_ptr, s);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Curve3DJs.__wrap(ret[0]);
     ...
     */
    spans() {
        const ret = wasm.curve3djs_spans(this.__wbg_ptr);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
     ...
     */
    closed() {
        const ret = wasm.curve3djs_closed(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     */
    length(tol) {
        const ret = wasm.curve3djs_length(this.__wbg_ptr, !isLikeNone(tol), isLikeNone(tol) ? 0 : tol);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return ret[0];
     ...
     * @param {Curve3DJs} other
     * @param {string} op
     * @param {number | null} [_tol]
     * @returns {BooleanRegion3DJs[]}
     */
    boolean(other, op, _tol) {
        _assertClass(other, Curve3DJs);
        const ptr0 = passStringToWasm0(op, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.curve3djs_boolean(this.__wbg_ptr, other.__wbg_ptr, ptr0, len0, !isLikeNone(_tol), isLikeNone(_tol) ? 0 : _tol);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
     ...
     */
    reverse() {
        const ret = wasm.curve3djs_reverse(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Curve3DJs.__wrap(ret[0]);
    ...
    subtype() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.curve3djs_subtype(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    clone() {
        const ret = wasm.curve3djs_clone(this.__wbg_ptr);
        return Curve3DJs.__wrap(ret);
    }
    /**
     ...
     */
    hasArcs() {
        const ret = wasm.curve3djs_hasArcs(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
     ...
     * @returns {Curve3DJs}
     */
    static makeArc(start, mid, end) {
        _assertClass(start, Point3Js);
        _assertClass(mid, Point3Js);
        _assertClass(end, Point3Js);
        const ret = wasm.curve3djs_makeArc(start.__wbg_ptr, mid.__wbg_ptr, end.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Curve3DJs.__wrap(ret[0]);
     ...
     */
    pointAt(t) {
        const ret = wasm.curve3djs_pointAt(this.__wbg_ptr, t);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    intersect(other, tol) {
        _assertClass(other, Curve3DJs);
        const ret = wasm.curve3djs_intersect(this.__wbg_ptr, other.__wbg_ptr, !isLikeNone(tol), isLikeNone(tol) ? 0 : tol);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
        var v1 = getArrayJsValueFromWasm0(ret[0], ret[1]).slice();
     ...
     */
    isPlanar() {
        const ret = wasm.curve3djs_isPlanar(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    ...
    static makeLine(a, b) {
        ...
        const ret = wasm.curve3djs_makeLine(a.__wbg_ptr, b.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return Curve3DJs.__wrap(ret[0]);
    ...
    translate(offset) {
        ...
        const ret = wasm.curve3djs_translate(this.__wbg_ptr, offset.__wbg_ptr);
        return Curve3DJs.__wrap(ret);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_booleanregion3djs_new = function(arg0) {
